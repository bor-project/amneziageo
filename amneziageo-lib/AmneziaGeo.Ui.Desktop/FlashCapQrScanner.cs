...
/// <summary>
/// FlashCap camera scanner for desktop (Windows/Linux): opens the default camera, previews frames, and decodes
/// QR codes from them.
/// </summary>
internal sealed class FlashCapQrScanner(Action<Bitmap> onPreview, Action<string> onDecoded) : IQrCameraScanner
{
