...
internal sealed partial class WindowsFirewall(ILogger<WindowsFirewall> logger) : IDisposable
{
    ...
    /// </summary>
    public bool Enable(uint tunnelInterfaceIndex, bool killSwitch, bool dualStack, string? underlayAppPath = null, IReadOnlyList<string>? extraLanCidrs = null, bool softBlock = false, IPAddress? underlayEndpoint = null)
    {
        lock (_gate)
        {
            DisableLocked();
