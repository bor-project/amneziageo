...
/// Absent row = defaults. UseIpv6: route IPv6 for this list (off keeps the tunnel v4-only). UseGlobalProxy:
/// route everything through the tunnel except the Direct bucket (full); off tunnels only the Proxy bucket (split).
/// </summary>
