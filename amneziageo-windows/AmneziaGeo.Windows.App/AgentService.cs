...
internal sealed class AgentService : ServiceBase
{
    ...
    /// ctor
    /// </summary>
    public AgentService(BalancerGroup group, int connectTimeoutSeconds, int deadThresholdSeconds, FileLogger logger)
    {
        _group = group;
    ...
    protected override void OnStart(string[] args)
    {
        ...
        var runner = new BalancerRunner(_group, _connectTimeoutSeconds, _deadThresholdSeconds, _logger.Log);
