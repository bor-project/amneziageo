...
internal sealed partial class GeneralViewModel : ViewModelBase
{
    ...
    // Set while Apply seeds the update settings from the snapshot; suppresses their autosave push.
    ...
    public void Apply(StatusSnapshot snapshot)
    {
        ...
        // Seed the update setting without echoing an autosave push back to the agent.
