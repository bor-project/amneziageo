...
|---|---|---|---|
| [`amneziageo-desktop/core`](amneziageo-desktop/core/) | shared (C#) | .NET class library — geo parsing, config, DNS proxy, UAPI client | 📋 planned |
| [`amneziageo-desktop/windows`](amneziageo-desktop/windows/) | Windows | C# host + `tunnel.dll` (c-shared) via P/Invoke | 🚧 first target |
